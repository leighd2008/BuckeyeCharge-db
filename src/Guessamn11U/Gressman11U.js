...
const Guessamn = ({ backgroundImage, teamName, statement, eventUrls }) => {
  const contact1="Head Coach: Nick Guessamn (buckeyechargefastpitch@gmail.com)"
