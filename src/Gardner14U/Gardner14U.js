...
const Gardner14U = ({ backgroundImage, teamName, statement, eventUrls }) => {
  const contact1="Head Coach: Pete Gardner (buckeyechargefastpitch@gmail.com)"
