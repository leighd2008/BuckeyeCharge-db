...
const Cavanagh16U = ({ backgroundImage, teamName, statement, eventUrls }) => {
  const contact1="Head Coach: Kevin Cavanagh (buckeyechargefastpitch@gmail.com)"
