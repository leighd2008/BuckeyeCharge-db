...
const Yoder14U = ({ backgroundImage, teamName, statement, eventUrls }) => {
  const contact1="Head Coach: Ron Yoder (buckeyechargefastpitch@gmail.com)"
