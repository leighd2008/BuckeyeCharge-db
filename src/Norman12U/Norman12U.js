...
const Norman12U = ({ backgroundImage, teamName, statement, eventUrls }) => {
  const contact1="Head Coach: Jay Norman (buckeyechargefastpitch@gmail.com)"
